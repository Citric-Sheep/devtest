...
class TestElevatorService(unittest.TestCase):
    ...
    def test_create_elevator(self):
        ...
        print(f"\ncreate_elevator test: {elevator.to_dict()}")
    ...
    def test_get_elevator(self):
        ...
        print(f"\nget_elevator test: {retrieved_elevator.to_dict()}")
